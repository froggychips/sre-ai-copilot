...
7. **Cross-service correlation is out of scope here.** Linking incidents of different services (shared dependency, deploy in window, `calls` edge) is a later roadmap step and will be expressed as edges between incidents, never by relaxing rule 1.
